...
## :rocket: AirBnB Clone V4 - Web Dynamic

### Description
In this last part of the Airbnb project, we have worked on the manipulation of the DOM through jQuery for the dynamic part of the front-end.
